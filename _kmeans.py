...
def _kmeans_fls_plusplus(X, sample_weight, centers_init, max_iter=300,
    ...
    if verbose:
        print("Starting alspp: depth {} norm_it {}".format(depth, norm_it))
        print("heuristics:")
    ...
    for iteration in range(0, max_iter, norm_it):
        ...
        best_index, best_centers_min, best_labels_min, best_inertia_compare, best_inertia_min, inertia_unchanged_solution, best_found_pos = exchange_solutions(X, candidate_id, centers, clustercosts, depth, n_clusters, n_threads, norm_it,
...
def exchange_solutions(X, candidate_id, centers, clustercosts, depth, n_clusters, n_threads, norm_it, sample_weight, tol, verbose, x_squared_norms, max_iter,
                       heuristics):
    verbose_als = verbose
    verbose=False
...
class KMeans(TransformerMixin, ClusterMixin, BaseEstimator):
    ...
    def fit(self, X, y=None, sample_weight=None):
        ...
        if self._algorithm == "full":
            ...
            kmeans_single = _kmeans_fls_plusplus
            self._check_mkl_vcomp(X, X.shape[0])
        ...
        for i in range(self._n_init):
            ...
            elif kmeans_single == _kmeans_fls_plusplus:
                labels, inertia, centers, n_iter_ = kmeans_single(
                    X,
                    sample_weight,
                    centers_init,
