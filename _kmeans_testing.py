...
# Function to compare normal output of algorithm and output after using time-saving strategies.
def kmeans_als_plusplus_comp(X, sample_weight, centers_init, candidate_id, max_iter=300,
    ...
    # Initialize dictionary containing the solution outputs
    ...
    # If i == 0 we compute the unchange output of the algorithm. Otherwise we exchange center i-1 with the
    # current candidate and compute the resulting output after "depth" and "norm_it" many Lloyd-iterations.
    for i in range(k + 1):
...
# Additional variable and function for handeling plots and unrelated to compuations of the actual algorithm
plot_nr = 0
def plot_configuration(mode, X, centers, args={}):
    # retrieve contents of dictionary, such as the input parameters
    depth = args["depth"]
